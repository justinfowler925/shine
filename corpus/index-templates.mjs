...
md.push("Pick a row, copy its structure, shine-paint. Never clone vendor pixels.");
...
md.push("```");
md.push("");
md.push("No row for this screen → `inspiration.md` (fill the catalog) then build. Do not invent.");
md.push("");
