...
try{
 ...
 const counts=libraryInventory();assert.equal(counts.implementations.blocks,26);assert.equal(counts.implementations.pages,6);assert.equal(counts.references.total,216);
